    ...
    return <>
        <div className="pt-[90px] w-[88%] m-auto">
            ...
            <div className='w-[100%] text-center flex flex-col justify-center'>
                ...
                <p className="text-center text-xl mt-9 mb-[20px]">Over 20,000 high paying jobs  available everyday</p>
                <SearchBar></SearchBar>
                </div>
            </div>

            <div className="image mt-[40px] rounded w-[95%] m-auto">


        </div>

            <div className="mt-[120px] p-4 rounded px-[2.5%] bg-stone-200 flex justify-between items-center">
            <p className="text-3xl text-center basis-[50%]">Accelerate your Job Search</p>

            <div className='basis-[40%] text-xl leading-[40px]'>
            We're dedicated to career growth, offering a job platform designed for professionals at every level.
            </div>
            </div>


        <div className="mt-11 grid grid-cols-3 l gap-8">
